...
# has an over-fishing prior (i.e. P(hmsyrat > 1)
...
pdf(file="report/abc4b_plots.pdf")
...
system.time(zzz <- mcmc4.abc(nits1))
zzz$acp/nits1
...
system.time(mczzz <- mclapply(rep(mcnits,ncore),mcmc4.abc,mc.cores=ncore))
...
save.image("model/abc_run4b.rda", compress="xz")
