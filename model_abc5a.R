...
pdf(file="report/abc5a_plots.pdf")
...
system.time(zzz <- mcmc3a.abc(nits1))
zzz$acp/nits1
...
system.time(mczzz <- mclapply(rep(mcnits,ncore),mcmc3a.abc,mc.cores=ncore))
...
save.image("model/abc_run5a.rda", compress="xz")
